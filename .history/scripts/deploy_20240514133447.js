...
async function main() {
    ...
    const mintAmount = 1; // Define mintAmount as 1 or any other number you want
  ...
  let transaction = await nft.connect(user1).mint(mintAmount, { value: ethers.parseEther(1) })
