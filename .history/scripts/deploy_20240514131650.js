...
async function main() {
  ...
  // address1 is minting 1 nft to upload
  console.log('user 1 is minting one nft to address: 0x90F79bf6EB2c4f870365E785982E1f101E93b906')
  let transaction = await nft.connect(addr1).mint(1)
