  ...
  return (<>
    ...
    <Form onSubmit={(e) => listHandler(e)}>
        <Form.Group>
            ...
            <Form.Control name='first' type="text" placeholder="NFT address"/> <Form.Control name='second' type="number" placeholder="Token ID"/> <Form.Control name='third' type="text" placeholder="Price in Eth" />
            <br></br>
