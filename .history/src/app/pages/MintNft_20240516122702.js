...
const ListNft = ()  => {
  ...
  return (<>
    ...
    <Carousel.Item interval={1000}>
        <img style={{ maxWidth:'20%' }} src={IMAGES5} text="First slide" />
        <img style={{ maxWidth:'20%' }} src={IMAGES6} text="First slide" />
        <img style={{ maxWidth:'20%' }} src={IMAGES7} text="First slide" />
        <img style={{ maxWidth:'20%' }} src={IMAGES8} text="First slide" />
        <Carousel.Caption>
