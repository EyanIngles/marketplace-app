...
function OffCanvasExample({ show, handleClose }) {
  return (
    <Offcanvas show={show} onHide={handleClose} placement="top" onChange={console.log("close")}>
      <Offcanvas.Header closeButton >
        <Offcanvas.Title style={{ alignContent: 'center' }}>Thank you for listing your NFT!</Offcanvas.Title>
      </Offcanvas.Header>
      <Offcanvas.Body>
