...
// import dispatches
import {  setNetwork, setProvider } from './app/reducers/provider';
import { loadAccount, loadNetwork, loadProvider } from './app/reducers/dispatch';
...
const loadBlockchain = async () => {
 ...
 // loading network and dispatching the data
  let chainId = await loadNetwork(dispatch)
